...
import { showProgressPage, hideProgressPage, progSetEx, progLogWeight, progLogMeasurements, progSetMeasure, progEnableNotif, progTestNotif } from './js/progress.js';
...
window.progLogMeasurements = progLogMeasurements;
window.progSetMeasure      = progSetMeasure;
