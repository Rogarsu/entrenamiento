...
import { showNutritionPage, hideNutritionPage, nutSetTab, nutGoFund, nutToggleFund, nutSetTrainingHour, nutOpenRecipeModal, nutCloseRecipeModal } from './js/nutrition.js';
