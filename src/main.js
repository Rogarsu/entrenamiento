...
import { toggleNavDropdown, closeNavDropdown, navGoFisico, navGoHistorial, navGoReportes, navGoNutricion, navGoProgreso } from './js/nav.js';
import { showNutritionPage, hideNutritionPage, nutSetTab, nutGoFund, nutToggleFund, nutSetTrainingHour, nutOpenRecipeModal, nutCloseRecipeModal, nutSetView, nutToggleMeal, nutSetFoodFlag, nutToggleIngredients } from './js/nutrition.js';
import { showProgressPage, hideProgressPage, progSetEx, progLogWeight, progEnableNotif, progTestNotif } from './js/progress.js';
...
window.navGoProgreso  = navGoProgreso;
window.showProgressPage  = showProgressPage;
window.hideProgressPage  = hideProgressPage;
window.progSetEx         = progSetEx;
window.progLogWeight     = progLogWeight;
window.progEnableNotif   = progEnableNotif;
window.progTestNotif     = progTestNotif;
...
window.nutToggleMeal       = nutToggleMeal;
window.nutSetFoodFlag      = nutSetFoodFlag;
window.nutToggleIngredients = nutToggleIngredients;
