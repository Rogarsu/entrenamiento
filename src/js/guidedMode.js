...
import { muscleSvg, equipIcon, diffLabel, catLabel, muscleName } from './helpers.js';
...
// helpers imported: muscleSvg, equipIcon, diffLabel, catLabel, muscleName
  ...
  const descPanel = `
    <div class="gm-desc-grid">
      ...
      <div class="gm-desc-cell">
        ...
        <span class="gm-cat-badge">${catLabel(ex.category)}</span>
      </div>
    </div>
